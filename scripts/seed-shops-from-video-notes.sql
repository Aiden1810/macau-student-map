...
with seed(name, address, category, shop_type, rating_label, tags, features, review_text, student_discount, status) as (
  values
    (
      ...
      '正餐',
      '封神之作',
      array['日料','寿司','牛仔骨','黑虎虾','三文鱼鳍','明太子酱西葫芦'],
      array['适合拍照'],
